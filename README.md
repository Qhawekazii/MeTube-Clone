...
- Video grid: `script.js` renders videos from an array.
...
1. Show the homepage layout, sidebar, search bar, and video grid.
2. Explain the manual feature: dark mode uses `classList.toggle("dark")`.
3. Explain the Cursor-assisted category chips and hover preview.
